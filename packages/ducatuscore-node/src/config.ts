...
const Config = function(): ConfigType {
  let config: ConfigType = {
    ...
    dbName: process.env.NODE_DB_NAME || 'ducatuscore',
    dbPort: process.env.NODE_DB_PORT || '27017',
    dbUser: process.env.NODE_DB_USER || '',
    dbPass: process.env.NODE_DB_PASS || '',
    ...
    services: {
      api: {
        rateLimiter: {
          disabled: process.env.DISABLED_RATE_LIMITER === 'true' ? true : false,
