...
const errors = {
  ...
  INSUFFICIENT_DUCX_FEE: 'Your linked DucatusX wallet does not have enough DUCX for fee',
  ...
  LOCKED_DUCX_FEE: 'Your linked DucatusX wallet does not have enough DUCX for fee',
  ...
  NETWORK_SUSPENDED: '$network operations are currently suspended.',
