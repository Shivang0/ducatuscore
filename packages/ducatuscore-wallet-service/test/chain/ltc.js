...
const { DucatuscoreLibLtc } = require('@ducatus/ducatuscore-crypto');
  ...
  describe('#getEstimatedSize', () => {
    ...
    before(() =>  {
      ...
      simpleUtxoWith1LTC = {
        ...
        outputIndex: 0,
        script: DucatuscoreLibLtc.Script.buildPublicKeyHashOut(fromAddress).toString(),
        satoshis: 1e8,
      };

      const privKey = new DucatuscoreLibLtc.PrivateKey();
    });
    ...
    it('1 input p2pkh,1 output p2pkh: Margin should be 10%', () => {
      ...
      // Create a similar TX.
      let tx = new DucatuscoreLibLtc.Transaction();
    ...
    const p2shPrivateKey1 = DucatuscoreLibLtc.PrivateKey.fromWIF('T4EAFWF8i3vFtgXW8nwRQWgSo2E3VEp5D3vbv27umAjUCQQrsqFQ');
    const p2shPublicKey1 = p2shPrivateKey1.toPublicKey();
    const p2shPrivateKey2 = DucatuscoreLibLtc.PrivateKey.fromWIF('T4PcE9qqC9UNhB5Xb694epiXXEYW6xp6aA8QHT4UB83UfcDVicew');
    const p2shPublicKey2 = p2shPrivateKey2.toPublicKey();

    const p2shAddress = DucatuscoreLibLtc.Address.createMultisig([
      p2shPublicKey1,
      p2shPublicKey2,
    ], 2, 'testnet');
    const p2shUtxoWith1BTC = {
      ...
      txId: 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
      outputIndex: 0,
      script: DucatuscoreLibLtc.Script(p2shAddress).toString(),
      satoshis: 1e8
    };
