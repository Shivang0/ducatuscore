...
A PublicKey in Ducatuscore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
```javascript
> var ducatuscore = require('ducatuscore');
...
> var compressedPK2 = new ducatuscore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = ducatuscore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
