...
var HDPublicKey = ducatuscore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = ducatuscore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(ducatuscore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(ducatuscore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      ducatuscore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = ducatuscore.PublicKey.fromPoint;
      ducatuscore.PublicKey.fromPoint = function() {
        ducatuscore.PublicKey.fromPoint = unstubbed;
